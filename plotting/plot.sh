...
if [ "$1" = "domains" ];  then
  python3 main.py domains $DOMAIN_ARGS
elif [ "$1" = "artefacts" ]; then
  python3 main.py artefacts $ARTEFACT_ARGS
elif [ "$1" = "graphs" ]; then
  python3 main.py graphs $GRAPH_ARGS
elif [ "$1" = "features" ]; then
  python3 main.py features $FEATURES_ARGS
elif [ "$1" = "models" ]; then
  python3 main.py models $MODELS_ARGS
elif [ "$1" = "all" ]; then
